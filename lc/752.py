        ...
        while dq:
            for _ in range(len(dq)):
                ...
                for j in range(4):
                    r_l = self.left(n, j)
                    r_r = self.right(n, j)
                    if r_l not in deadends:
                        deadends.add(r_l)
                        dq.append(r_l)
                    if r_r not in deadends:
                        deadends.add(r_r)
                        dq.append(r_r)
            step += 1
